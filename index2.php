    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#organisations">Consulting</a></li>
          <li><a href="#pricing">Free Resources</a></li>
           ...
           <div class="col-sm-6">
            <div class="banner-text text-center">
              <div class="text-border">
                <h2 class="text-dec">Compassion</h2>
              </div>
              <div class="intro-para text-center quote">
                <p class="big-text">Dramatically enhancing the experiences </p>
                <p class="small-text">of both patients and professionals through the heart, science and business of compassion.</p>
